	...
	<view class="content">
		...
		<view class="wrap">
			...
			<view class="input_wrap mt20">
				<input class='input' v-model="account_id" type="text" placeholder="Account ID" />
			</view>
			...
			<view class="input_wrap mt20">
				<input class='input' v-model='nric' type="text" placeholder="NRIC(Last 4 digits & letter)" />
			</view>
			...
			<view class="input_wrap mt20">
				<input class='input' v-model="payment_amount" type="text" placeholder="Deposit Paid" />
			</view>
			...
			<view class="input_wrap mt20">
				<input class='input' v-model="package_amount" type="text" placeholder="Package Amount" />
			</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			submit(){
				// 首页提交接口
				let url='http://ec2-52-76-78-186.ap-southeast-1.compute.amazonaws.com/api/1.2/web/module_event_bows/recordpayment.php'
			}
		}
	}
</script>
